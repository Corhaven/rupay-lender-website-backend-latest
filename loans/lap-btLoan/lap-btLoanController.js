...
const text =await leadTextMessage(applicationID,details.personalDetail.username,subAdminName,'loan against property bt')
const html =await leadHtmlMessage(applicationID,details.personalDetail.username,subAdminName,'loan against property bt')

await sendEmail(leadSubject,html,text,recipients)

const admin = await adminModel.find({});
    // console.log("admin",admin)
    notifyAdmin(admin[0]._id, 'loan subbmission',"loan Against Property bt submit");
