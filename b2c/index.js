...
const { referralProgramRegister, getReferralProgramEntries } = require("./controllers/referralProgramController")
...
b2cRouter.post("/referral-program/register", referralProgramRegister)
b2cRouter.get("/referral-program/entries", authMiddleware, getReferralProgramEntries)
